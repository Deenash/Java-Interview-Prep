...
public class SamePackageButChildClass extends AccessModifierClass  {
	...
	public void printByPassingAccessModifierClassObjectAsParam(AccessModifierClass j){
		...
		System.out.println(prot);//you can access directly since it is a child class
		System.out.println(j.def);
		System.out.println(def);//you can access directly since it is a child class and also same package
		System.out.println(j.pub);
		System.out.println(pub);//you can access directly since it is a child class and also same package
