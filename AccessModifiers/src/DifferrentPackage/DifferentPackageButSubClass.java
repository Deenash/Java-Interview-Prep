...
public class DifferentPackageButSubClass extends AccessModifierClass {
	public void printByPassingAccessModifierClassObjectAsParam(AccessModifierClass j){
		...
		AccessModifierClass am_Simply = new AccessModifierClass();//you can create an object inside
		//class just like that , i.e. without inside a method
		
		DifferentPackageButSubClass dpbsc = new DifferentPackageButSubClass();//This statement is
		//wrong. No syntax error but run time error . You will get stack overflow error.
